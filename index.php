...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBnLV1XRYiC0t-YDg9wWcO304_c0Z1LKXY"></script>
    <script>
	var map;
	var markersArray= [];
	...
	function myMap(){
		map = new google.maps.Map(document.getElementById("map-canvas"),{
			center: {lat: -7.2759773, lng: 112.7829208},
			zoom:13,
		});
	...
	//route
	function calcRoute(){
		var start = '-7.276498, 112.794871';
		var end = '-7.279743, 112.795059';
		var request = {
			origin:start,
			destination:end,
...
<body>
			...
			<div class="sidebar">
				...
				<form method="POST" action="" >
					<div class="input-group">
						<h5>Input Amount of Important Package</h5>
						<input id="max" value="" type="text" name="maks" class="form-control" />
						<h5>Input Amount of Regular Package</h5>
						<input id="max123" value="" type="text" name="dir" class="form-control"></input>
						<button type="button" class="btn btn-success">Submit</button>      
						<button onClick="clearMapMarkers()">Clear</button>
					</div>
				</form> 
			</div>
	...
	<!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBg8Nx4b3UA_1fFBDXb9v1Su1uLG03gF7w">
</script>-->
...
<!--<html>
<head>
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyBg8Nx4b3UA_1fFBDXb9v1Su1uLG03gF7w"></script>
